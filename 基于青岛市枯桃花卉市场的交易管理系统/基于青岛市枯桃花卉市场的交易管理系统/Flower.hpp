...
class Flower {
 public:
    Flower(); //默认构造函数
    Flower(string &f_name, string &s_name, string &p_color, float f_price, int yy, int mm, int dd);//进行初始化的构造函数
    void SetFlowerInfo(string &f_name, string &s_name, string &p_color, float f_price, int yy, int mm, int dd); //设置花卉信息
